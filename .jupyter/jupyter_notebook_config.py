...
def _disable_downloads():
  ...
  # pylint: disable=unused-import,undefined-variable,g-import-not-at-top
  from jupyter_server.base import handlers

  class ForbidFilesHandler(handlers.JupyterHandler):
  ...
  # pylint: enable=unused-import,undefined-variable,g-import-not-at-top
